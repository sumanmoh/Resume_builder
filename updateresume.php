                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="nationality">
                            ...
                            <option <?=($resume['natinality']=='Non Indian')?'selected':''?>>Non Indian</option>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="address" class="form-control" value="<?=@$resume['address']?>" id="inputAddress" placeholder="1234 Main St" required>
                    </div>
                    <hr>
...
<div class="modal fade" id="addexp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-12">
    ...
    <input type="text" name="position" placeholder="Web Developer Consultant (2+ Years)" class="form-control" id="inputEmail4" required>
  </div>
  <div class="col-12">
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="ended" placeholder="Currently persuing" class="form-control" id="inputPassword4">
  </div>
  <div class="col-12">
...
<div class="modal fade" id="addedu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-12">
    ...
    <input type="text" name="course" placeholder="Completed 12th Class (Arts Stream)" class="form-control" id="inputEmail4" required>
  </div>
  <div class="col-12">
    <label for="inputPassword4" class="form-label">Institute</label>
    <input type="text" name="institute" placeholder=" Central Board Of Secondary Education, New Delh" id="inputPassword4" required>
  </div>
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Started</label>
    <input type="text" name="started" placeholder="October 2021" class="form-control" id="inputPassword4">
...
<div class="modal fade" id="addskill" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-12">
    ...
    <input type="text" name="skill" placeholder="Basic Knowledge in Computer & Internet" class="form-control" id="inputEmail4" required>
  </div>
