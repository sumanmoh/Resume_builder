...
if ($_POST) {
    ...
    if ($post['email_id']) {
        ...
        $result = $conn->query("SELECT id,full_name FROM users WHERE email_id='$email_id'");
...
try {
    ...
    $mail->Username   = 'mmanoranjan199@gmail.com';                     //SMTP username
    $mail->Password   = 'fuybjcarxnoexbua';                               //SMTP password
